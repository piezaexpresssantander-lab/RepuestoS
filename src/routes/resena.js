...
const { httpResena } = require('../controllers/reseña.js');
...
router.post('/crear', [
  ...
  check('usuario').custom(async (usuario, { req }) => {
    await reseñaHelper.existeResenaDiariaPorUsuarioProducto(usuario, req.body.producto);
  }),
